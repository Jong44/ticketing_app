    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div class="lg:col-span-2">
        <div class="card bg-base-100 shadow">
          <figure>
            <img
              src="{{ $event->gambar ? asset($event->gambar) : 'https://img.daisyui.com/images/stock/photo-1606107557195-0e29a4b5b4aa.webp' }}"
      ...
      <aside class="lg:col-span-1">
        <div class="card sticky top-24 p-4 bg-base-100 shadow">
          ...
          <button onclick="openCheckout()" class="btn btn-primary btn-block mt-4" id="checkoutButton"
    ...
    <dialog id="checkout_modal" class="modal">
      <form method="dialog" class="modal-box">
        ...
        <div class="modal-action">
          ...
          <button type="button" class="btn btn-primary" id="confirmCheckout">Konfirmasi (placeholder)</button>
        </div>
      </form>
    </dialog>
