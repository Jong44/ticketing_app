<x-layouts.admin_layouts title="Detail Event">
                    ...
                    <div id="imagePreview" class="hidden overflow-hidden">
                        ...
                        <div class="avatar max-w-sm">
                            <div class="w-full rounded-lg">
                                @if ($event->gambar)
                                <img id="previewImg" src="{{ asset('events/' . $event->gambar) }}" alt="Preview">
                                @else
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $ticket->stok }}</td>
                                <td>
                                    <button class="btn btn-sm btn-primary mr-2" onclick="openEditModal(this)" data-id="{{ $ticket->id }}" data-tipe="{{ $ticket->tipe }}" data-harga="{{ $ticket->harga }}" data-stok="{{ $ticket->stok }}">Edit</button>
    ...
    <dialog id="add_ticket_modal" class="modal">
        <form method="POST" action="{{ route('tickets.store') }}" class="modal-box">
            @csrf
